    ...
    def get_nml_attributes(
        ...
        if nml_block == "glm_setup":
            ...
            glm_setup.set_attributes(
                json_data["glm_setup"], custom_attrs=custom_attributes
            )
            return str(glm_setup)
        elif nml_block == "mixing":
            mixing = NMLMixing()
            mixing.set_attributes(
                json_data["mixing"], custom_attrs=custom_attributes
            )
            return str(mixing)
        elif nml_block == "morphometry":
            morphometry = NMLMorphometry()
            morphometry.set_attributes(
                json_data["morphometry"], custom_attrs=custom_attributes
            )
            return str(morphometry)
        elif nml_block == "time":
            time = NMLTime()
            ...
            bird_model.set_attributes(
                json_data["bird_model"], custom_attrs=custom_attributes
            )
            return str(bird_model)
        elif nml_block == "inflows":
            inflows = NMLInflows()
            inflows.set_attributes(
                json_data["inflows"], custom_attrs=custom_attributes
            )
            return str(inflows)
        elif nml_block == "outflows":
            outflows = NMLOutflows()
            outflows.set_attributes(
                json_data["outflows"], custom_attrs=custom_attributes
            )
            return str(outflows)
        elif nml_block == "sediment":
            sediment = NMLSediment()
            sediment.set_attributes(
                json_data["sediment"], custom_attrs=custom_attributes
            )
            return str(sediment)
        elif nml_block == "ice_snow":
            ice_snow = NMLIceSnow()
            ice_snow.set_attributes(
                json_data["ice_snow"], custom_attrs=custom_attributes
            )
            return str(ice_snow)
        elif nml_block == "wq_setup":
            wq_setup = NMLWQSetup()
            wq_setup.set_attributes(
                json_data["wq_setup"], custom_attrs=custom_attributes
            )
            return str(wq_setup)
