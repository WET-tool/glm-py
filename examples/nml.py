...
class NML:
    ...
    """ Class for generating a .nml file
    ...
    -------
    write_nml(file_name)
        Writes the .nml file to the specified file_name
    """

    def __init__(
        self, setup: Union[str, None], mixing: Union[str, None], morphometry: Union[str, None],
        time: Union[str, None], output: Union[str, None], init_profiles: Union[str, None],
        meteorology: Union[str, None], light: Union[str, None], bird_model: Union[str, None],
        inflows: Union[str, None], outflows: Union[str, None], sediment: Union[str, None],
        ice_snow: Union[str, None], wq_setup: Union[str, None]
    ):
        self.setup = setup
        self.mixing = mixing
    ...
    def write_nml(self, file_name: str = "sim.nml"):
